...
$(function() {
    ...
    $("#uploader").pluploadQueue({
        ...
        url : '${pageContext.request.contextPath}/uploadFileAction',
       // chunk_size : '1mb',
        unique_names : true,
        ...
        init : {
            ...
            BeforeUpload: function(up, file) {
               ...
               // log('[BeforeUpload]', 'File: ', file);
            	up.setOption('url','${pageContext.request.contextPath}/uploadFileAction?dir=${param.dir}'); 
            },
            ...
            UploadComplete: function(up, files) {
               ...
               // log('[UploadComplete]');
               //alert("上传成功");
               window.parent.location.href="${pageContext.request.contextPath}/listFileAction"
            },
